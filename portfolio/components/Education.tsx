...
const Education = () => {
  ...
  return (
    <section id='education' className='max-w-containers mx-auto py-10 lgl:py-24 px-4'>
      <SectionTitle title="Where I gained Knowledge" />
      <div className='w-full mt-10 flex flex-col md:flex-row md:justify-end gap-16'>
